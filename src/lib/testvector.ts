    ...
    [document.id]: {
      didDocumentDataModel: {
        properties: {
          id: document.id,
          verificationMethod:
            document.serializeRelationship("verificationMethod"),
          ...
          capabilityInvocation: document.serializeRelationship(
            "capabilityInvocation"
          ),
          capabilityDelegation: document.serializeRelationship(
